...
Route::get('/events/{slug}', [HomeController::class, 'eventDetail'])->name('events.detail');
Route::get('/speakers', [HomeController::class, 'speakers'])->name('speakers');
Route::get('/speakers/{slug}', [HomeController::class, 'speakerDetail'])->name('speakers.detail');
